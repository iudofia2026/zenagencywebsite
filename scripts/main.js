...
const reelWraps = document.querySelectorAll('#reels .reels-grid > .vwrap-plain, #reels .reels-grid > .hwrap-plain, #reels .reels-grid > .vwrap-longform, #reels .showcase-grid > .tile');
if(reelWraps.length){
